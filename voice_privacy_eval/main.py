...
def run_vp_eval(args):
    ...
    with concurrent.futures.ThreadPoolExecutor() as executor:
        # ASR in batches
        for batch in chunked(asr_models, 2):
            for model in batch:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--out_path', default='test_out.xlsx')
    parser.add_argument('--config_path', default='./configs/privacy_config_simple.json')
    parser.add_argument('--language', default='English')
    parser.add_argument('--protocol_path', default='./filelists/LibriSpeech_Dev_m.xlsx')
